        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                    ...
                    <input className="form-control" id="fname" aria-describedby="fname" placeholder="Enter First Name"
                           value={fName} onChange={e => setfName(e.target.value)}/>
                </div>
                <div className="form-group">
                    <label htmlFor="lName">Last Name:</label>
                    <input className="form-control" id="lName" aria-describedby="lName" placeholder="Enter Last Name"
                ...
                <div className="form-group">
                    ...
                    <input className="form-control" id="address" aria-describedby="address" placeholder="Enter Address"
